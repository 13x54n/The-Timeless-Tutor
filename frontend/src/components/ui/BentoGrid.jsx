...
export const BentoGridItem = ({ title, description, imageUrl }) => {
  return (
    <div className="cursor-pointer row-span-1 rounded-xl group/bento hover:shadow-xl transition duration-200 shadow-input p-4 bg-white border border-2 justify-between flex flex-col space-y-2">
      <img
        src={imageUrl}
        alt=""
